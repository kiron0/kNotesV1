          ...
          return (
                    <div className="mx-auto text-white py-10">
                              <div className="text-center">
                                        <h3 className="text-3xl mb-3 font-bold">KNotes</h3>
                              ...
                              <div className='flex flex-col justify-center items-center pt-6'>
                                        <p className='text-xs md:text-sm'>Copyright &copy; {new Date().getFullYear()} <span className='text-primary font-bold'>KNotes</span> - All Rights reserved.</p>
